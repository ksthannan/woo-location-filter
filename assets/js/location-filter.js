  ...
  function setCookie(name,value,days) {
    ...
    document.cookie = name + "=" + (value || "")  + expires + "; path=/";
      ...
      locations.on( 'select2:select', function(e) {
          ...
          setCookie("locationselect", selectedLocation, 7);
	  ...
	  /* popup location */
	  if ( !( getCookie( 'locationselect' ) ) && locationfilter.popup == 1) {
		$( ".site-location > a" ).trigger( "click" );

	  }

    if ( getCookie( 'locationselect' ) ){
      $('.close-popup.btn_hide').css('display', 'block');
    }
